(function () {
  ...
  const css = `
    ...
    #pce-launcher svg { width: 26px; height: 26px; fill: #fff; transition: opacity .2s; pointer-events: none; }
    ...
    .pce-header-info p {
      margin: 2px 0 0; font-size: 11px; opacity: .8; color: #fff;
    }
    .pce-dot {
    ...
    /* Typing dots */
    .pce-typing .pce-bubble {
      display: flex; gap: 4px; align-items: center; padding: 12px 16px;
    }
    .pce-dot-anim {
      width: 6px; height: 6px; border-radius: 50%; background: #0052cc;
      animation: pceBounce .9s infinite;
    }
    ...
    .pce-quick {
      background: #e8f0ff; color: #0052cc;
      border: 1px solid #0052cc; border-radius: 20px;
    ...
    .pce-send svg { fill: #fff; width: 15px; height: 15px; pointer-events: none; }
  ...
  launcher.innerHTML = `
    <svg class="pce-icon-chat" viewBox="0 0 24 24" width="26" height="26" style="width:26px;height:26px;flex-shrink:0"><path fill-rule="evenodd" d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0zM10.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0zM14.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0z"/></svg>
    <svg class="pce-icon-close" viewBox="0 0 24 24" width="26" height="26" style="width:26px;height:26px;flex-shrink:0"><path d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/></svg>
  ...
  panel.innerHTML = `
    ...
    <div class="pce-messages" id="pce-msgs">
      <div class="pce-welcome" id="pce-welcome">
        ...
        <p>Ask about our IT services, support plans, pricing, or contact info.</p>
    ...
    <div class="pce-input-wrap">
      ...
      <button class="pce-send" id="pce-send" aria-label="Send">
        <svg viewBox="0 0 24 24" width="15" height="15" style="width:15px;height:15px;flex-shrink:0"><path fill-rule="evenodd" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM20 8l-8 5-8-5V6l8 5 8-5v2z"/></svg>
      </button>
    </div>
  `;
  ...
  // Show badge after 3 s to nudge visitors
  setTimeout(() => {
  ...
  panel.addEventListener("click", (e) => {
    if (e.target.classList.contains("pce-quick")) {
