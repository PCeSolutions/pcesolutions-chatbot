(function () {
  ...
  launcher.innerHTML = `
    <svg class="pce-icon-chat" viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0zM10.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0zM14.5 12a1.5 1.5 0 1 0 3 0a1.5 1.5 0 0 0-3 0z"/></svg>
  ...
  panel.innerHTML = `
    ...
    <div class="pce-input-wrap">
      ...
      <button class="pce-send" id="pce-send" aria-label="Send">
        <svg viewBox="0 0 24 24"><path fill-rule="evenodd" d="M20 4H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zM20 8l-8 5-8-5V6l8 5 8-5v2z"/></svg>
      </button>
    </div>
  `;
